...
public class OpenFileDialog {
    ...
    public static Dialog createDialog(int id, Context context, String title, CallbackBundle callback, String suffix,
    ...
    static class FileSelectView extends ListView implements android.widget.AdapterView.OnItemClickListener {
        ...
        public FileSelectView(Context context, int dialogid, CallbackBundle callback, String suffix,
                Map<String, Integer> images) {
            super(context);
        ...
        private int refreshFileList() {
            ...
            SimpleAdapter adapter = new SimpleAdapter(getContext(), list, R.layout.filedialogitem, new String[] {
                    "img", "name", "path" }, new int[] { R.id.filedialogitem_img, R.id.filedialogitem_name,
